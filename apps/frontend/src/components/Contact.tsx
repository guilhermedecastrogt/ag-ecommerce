  ...
  return (
    <div className="relative h-[100dvh] flex items-center bg-neutral-light overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid lg:grid-cols-3 gap-6 section-content" style={{ transitionDelay: "150ms" }}>
          {/* Contact cards */}
          <div className="lg:col-span-1 space-y-3">
            {CONTACTS.map((c, i) => (
              <a
                ...
                className="sc-item flex items-start gap-3 bg-white border border-neutral-border rounded-xl p-4 card-hover group"
              >
                <div className="w-9 h-9 rounded-lg bg-blue/5 flex items-center justify-center text-blue group-hover:bg-red group-hover:text-white transition-all shrink-0">
            ...
            <a
              ...
              className="sc-item flex items-center justify-center gap-3 bg-[#25D366] text-white font-bold rounded-xl p-3.5 card-hover"
            >
              <IconWhatsApp className="w-5 h-5" />
              Chamar no WhatsApp
            </a>

            <div className="sc-item bg-white border border-neutral-border rounded-xl p-4">
          ...
          <div className="lg:col-span-2 sc-right">
            <div className="bg-white border border-neutral-border rounded-2xl overflow-hidden h-full min-h-[320px] flex items-center justify-center">
